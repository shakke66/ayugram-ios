...
private var declaredEncodables: Void = {
    ...
    declareEncodable(GRVMDeletedMessageAttribute.self, f: { GRVMDeletedMessageAttribute(decoder: $0) })
    declareEncodable(GRVMEditHistoryMessageAttribute.self, f: { GRVMEditHistoryMessageAttribute(decoder: $0) })
    declareEncodable(GRVMLocalPremiumEmojiMessageAttribute.self, f: { GRVMLocalPremiumEmojiMessageAttribute(decoder: $0) })
