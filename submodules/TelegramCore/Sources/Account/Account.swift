...
public class Account {
    ...
    public init(accountManager: AccountManager<TelegramAccountManagerTypes>, id: AccountRecordId, basePath: String, testingEnvironment: Bool, postbox: Postbox, network: Network, networkArguments: NetworkInitializationArguments, peerId: PeerId, auxiliaryMethods: AccountAuxiliaryMethods, supplementary: Bool, isSupportUser: Bool) {
        ...
        self.managedOperationsDisposable.add(managedAutoremoveMessageOperations(accountPeerId: self.peerId, network: self.network, postbox: self.postbox, isRemove: true).start())
        self.managedOperationsDisposable.add(managedAutoremoveMessageOperations(accountPeerId: self.peerId, network: self.network, postbox: self.postbox, isRemove: false).start())
